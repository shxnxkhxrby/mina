...
export const MINA_INTRO_DIALOGUES = [
  ...
  { speaker:'Mina', text:"No worries! First, we’ll visit local shops in Bustos that sell Minasa. Talking to the shop owners will help you: Practice your English by asking questions and reporting answers. Observe how Minasa is made and sold, which will help with your documentation task.", audio:'https://res.cloudinary.com/dh2nmgq2m/video/upload/v1775563615/3_pdexki.m4a' },
