...
// Floating particle for ambiance
...
// Scalloped / wavy border using SVG clip or CSS trick
...
export default function MinaIntro() {
  ...
  return (
    ...
    >
      ...
      {/* ── Mina mascot — large, anchored bottom-right ── */}
      <motion.div
        style={{
          position: 'absolute',
      ...
      {/* ── Dialogue box — upper left, clear of Mina ── */}
      <div style={{
        position: 'absolute',
        ...
        <AnimatePresence mode="wait">
          ...
          >
            {/* Speaker badge — styled like screenshot's orange "MINA" tag */}
            <motion.div
